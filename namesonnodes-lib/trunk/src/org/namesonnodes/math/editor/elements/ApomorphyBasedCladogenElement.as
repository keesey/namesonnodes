package org.namesonnodes.math.editor.elements
{
	...
	public final class ApomorphyBasedCladogenElement extends AbstractBinaryContainer implements MathMLContainer
	{
		public function ApomorphyBasedCladogenElement()
		{
			super();
		}
		override protected function get cloneBase() : MathMLContainer
		{
			return new ApomorphyBasedCladogenElement();
		}
		...
		{
			const m:XML = <apply xmlns={MathML.NAMESPACE.uri}><csymbol xmlns={MathML.NAMESPACE.uri} definitionURL="http://namesonnodes.org/ns/math/2009#def-ApomorphyBasedCladogen"/></apply>;
