package org.namesonnodes.math.editor.elements
{
	...
	public final class NotSubsetElement extends AbstractBinaryContainer implements MathMLContainer
	{
		public function NotSubsetElement()
		{
			super();
		}
		...
		{
			const m:XML = <apply xmlns={MathML.NAMESPACE.uri}><notsubset xmlns={MathML.NAMESPACE.uri}/></apply>;
		...
		{
			return "Not a Subset: tells whether a set (sub) is not a subset of another set (sup). Does not hold true if the sets are equal.";
		}
