package org.namesonnodes.math.editor.elements
{
	...
	public final class SynapomorphicPredecessorsElement extends AbstractBinaryContainer implements MathMLContainer
	{
		public function SynapomorphicPredecessorsElement()
		{
			super();
		}
		override protected function get cloneBase() : MathMLContainer
		{
			return new SynapomorphicPredecessorsElement();
		}
		...
		{
			const m:XML = <apply xmlns={MathML.NAMESPACE.uri}><csymbol xmlns={MathML.NAMESPACE.uri} definitionURL="http://namesonnodes.org/ns/math/2009#def-SynapomorphicPredecessors"/></apply>;
